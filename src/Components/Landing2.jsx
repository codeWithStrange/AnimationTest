...
const Landing = () => {
	useEffect(() => {
		...
		words.forEach((word, index) => {
			...
			textTimeline.to('.typewriter', {
				duration: 3, // Duration of the text animation
				text: word, // Update the text content to the current word
				ease: 'power1.inOut' // Optional easing for the animation
			});
	...
	useEffect(() => {
		...
		// Create a single animation for all background elements using fromTo
